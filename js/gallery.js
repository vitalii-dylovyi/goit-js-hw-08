...
const galleryElements = images.map((image) => {
  ...
  galleryLinkEl.setAttribute("href", image.original);
...
galleryEl.addEventListener("click", (e) => {
  ...
  if (targetEl.nodeName === "IMG") {
    ...
    originalImage.setAttribute("src", targetEl.getAttribute("data-source"));
    originalImage.setAttribute("alt", targetEl.alt);
